...
public class ChannelBulletin {
   ...
   */
  private static String VIDEO_ID = "m-2waXSWQhI";
  ...
  private static Credential authorize(List<String> scopes) throws Exception {
    ...
    // Load client secrets.
    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, ChannelBulletin.class.getResourceAsStream("/client_secrets.json"));
