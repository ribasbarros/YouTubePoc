...
public class UploadVideo {
  ...
  private static Credential authorize(List<String> scopes) throws Exception {
    ...
    // Load client secrets.
    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, UploadVideo.class.getResourceAsStream("/client_secrets.json"));
  ...
  public static void main(String[] args) {
    ...
    String url = "https://www.googleapis.com/auth/youtube.upload";
