...
public class AddFeaturedVideo {
    ...
    private static Credential authorize(List<String> scopes) throws IOException {
        ...
        // Load client secrets.
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, AddFeaturedVideo.class.getResourceAsStream("/client_secrets.json"));
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<PromotedItemId> aa = Lists.newArrayList();
            aa.add(promotedItemId);
			invideoPromotion.setItems(aa);
            ...
            System.out.println("\t- Promotion timing: " + promotion.getTiming().getOffsetMs() + " Offset: " + promotion.getTiming().getType());
